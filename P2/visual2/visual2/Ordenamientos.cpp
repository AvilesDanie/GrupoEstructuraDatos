...
void Ordenamientos::menuOrdenamiento(int opcionActual) {
    ...
    for (int i = 1; i <= 7; i++) {
        ...
        switch (i) {
        case 1:
            cout << "Ordenamiento burbuja_________" << ANSI_COLOR_RESET << endl;
            break;
        case 2:
...
int Ordenamientos::operarMenuOrdenamiento(ListaCircularDoble lista) {
    int opcionActual = 1;
    ...
    while (true) {
        ...
        case 13:
            ...
            switch (opcionActual) {
            case 1:
                cout << "\t === Ordenamiento burbuja_________ ===" << endl;
                lista.burbuja(lista.getCabeza(), lista.getCabeza()->getSiguiente(), false);
                lista.mostrar();
                break;
            case 2:
